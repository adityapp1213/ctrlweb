...
function PortraitButton({
  ...
  return (
    <motion.button
      ...
      className="group relative h-full min-h-[24rem] w-full cursor-pointer overflow-hidden bg-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#e2687d] sm:min-h-[32rem] lg:min-h-[38rem]"
...
function MobilePortraitStory({
  ...
  return (
    <div ref={storyRef} className="relative h-[115svh] bg-transparent md:hidden">
      <div className="sticky top-[7.5rem] flex h-[calc(78svh-7.5rem)] min-h-[30rem] flex-col overflow-hidden bg-transparent">
          ...
          {profiles.map((profile, index) => {
            ...
            return (
              <motion.button
                ...
                className="absolute inset-0 overflow-hidden bg-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#e2687d]"
                initial={false}
                animate={{
              ...
              >
                ...
                />
                <motion.div
                  className="absolute inset-x-4 bottom-4 z-20 flex items-end justify-between gap-4 border-t border-black/10 bg-white/95 px-3 pt-3 text-left"
                  initial={false}
...
function ProfilePanel({
  ...
  return (
    <motion.div
      className="relative mx-auto grid w-full max-w-7xl overflow-hidden bg-transparent md:min-h-[40rem] md:grid-cols-[minmax(0,1.34fr)_minmax(22rem,0.76fr)] lg:min-h-[42rem]"
    ...
    >
      ...
      <motion.div
        className="relative min-h-[20rem] overflow-hidden bg-transparent sm:min-h-[24rem] md:min-h-full"
  ...
  return (
    <AnimatePresence mode="wait" initial={false}>
      {selectedProfile ? (
        ...
        <div
          key="team"
          className="relative mx-auto w-full max-w-7xl bg-transparent"
        >
